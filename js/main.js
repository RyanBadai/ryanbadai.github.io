(function () {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    const categories = document.querySelectorAll(".work-menu a");
    const projects = document.querySelectorAll(".blog-entry");
    ...
    categories.forEach(category => {
        category.addEventListener("click", function(event) {
            ...
            projects.forEach(project => {
                if (filter === "all" || project.parentElement.classList.contains(filter)) {
